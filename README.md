...
<p align="center"><b>Mathematics (Data Science) — Saint Joseph University of Beirut</b><br>
...
I'm a final-year math/data-science student building end-to-end ML pipelines — from raw
data (fMRI scans, tweets, transaction logs) to evaluated models to deployed apps. My
final-year project uses machine learning on resting-state fMRI to classify Parkinson's
...
**78.5% accuracy**, 4-class value tiers · silhouette = 0.53 clustering
...
**B.Sc. Mathematics — Data Science**, Saint Joseph University of Beirut (USJ) · Final year
